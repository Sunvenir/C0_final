	...
	struct formatter<miniplc0::ErrorCode> {
		...
		auto format(const miniplc0::ErrorCode &p, FormatContext &ctx) {
			...
			case miniplc0::ErrNeedInt:
				name = "ErrNeedInt";
				break;
			case miniplc0::ErrNeedLEFT_BRACKET:
				name = "ErrNeedLEFT_BRACKET";
				break;
			case miniplc0::Errparameter_clause:
				name = "Errparameter_clause";
				break;
			case miniplc0::Errcompound_statement:
				name = "Errcompound_statement";
				break;
			case miniplc0::Errstatement_seq:
				name = "Errstatement_seq";
				break;
			case miniplc0::Errcondition:
				name = "Errcondition";
				break;
			case miniplc0::Errexpression:
				name = "Errexpression";
				break;
			case miniplc0::ErrReturn:
				name = "ErrReturn";
				break;
			case miniplc0::ErrArgsnum:
				name = "ErrArgsnum";
				break;
			case miniplc0::ErrNeedRIGHT_BRACKET:
				name = "ErrNeedRIGHT_BRACKET";
				break;
			case miniplc0::ErrvoidExpresion:
				name = "ErrvoidExpresion";
				break;
			}
