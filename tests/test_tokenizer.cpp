...
//		FAIL();
//	std::vector<miniplc0::Token> output = {};
//	output.emplace_back(miniplc0::Token(miniplc0::TokenType::UNSIGNED_INTEGER, 172, 0, 0, 0, 4));
...
//		FAIL();
//	std::vector<miniplc0::Token> output = {};
//	output.emplace_back(miniplc0::Token(miniplc0::TokenType::IDENTIFIER, std::string("begin"), 0, 0, 0, 5));
//	output.emplace_back(miniplc0::Token(miniplc0::TokenType::SCAN, std::string("scan"), 1, 0, 1, 4));
//	output.emplace_back(miniplc0::Token(miniplc0::TokenType::CONST, std::string("const"), 2, 0, 2, 5));
//	output.emplace_back(miniplc0::Token(miniplc0::TokenType::IDENTIFIER, std::string("var"), 3, 0, 3, 3));
